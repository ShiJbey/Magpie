...
blender --background --python export-transform-animation-hierarchy.py -- magpie.blend magpieWalk_GRP 0 60 %DIST%/player_walk.manim
blender --background --python export-transform-animation-hierarchy.py -- magpie.blend magpieIdle_GRP 0 60 %DIST%/player_idle.manim
blender --background --python export-transform-animation-hierarchy.py -- magpie.blend magpieSteal_GRP 0 60 %DIST%/player_steal.manim
