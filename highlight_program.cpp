...
HighlightProgram::HighlightProgram() {
	program = compile_program(
		...
		"	}\n"
        "   fragColor = vec4(color.rgb * total_light, 0.2);\n"
		"}\n"
	);
...
Load< HighlightProgram > highlight_program(LoadTagInit, [](){
	return new HighlightProgram();
});
