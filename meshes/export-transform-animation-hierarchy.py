...
# Based on export_transform_animation.py
# Exports transform information for all the objects below the given object in the Blender hierarchy
# Saves time from having to name all the body parts of the character model
...
for object_name in object_names:
	...
	objects_to_add = queue.Queue()

	obj = bpy.data.objects[object_name]
	objects_to_add.put(obj)

	while not objects_to_add.empty():
		# Get an object off the queue
		current_obj = objects_to_add.get()
